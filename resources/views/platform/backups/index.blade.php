        ...
        <div class="mx-auto max-w-5xl sm:px-6 lg:px-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="text-lg font-medium">Backup History</h3>
                </div>
                            ...
                            <tbody>
                                @forelse($backups ?? [] as $backup)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-gray-600 dark:text-gray-400">{{ $backup->createdBy?->name ?? 'System' }}</span>
                                        </td>
                                        <td class="text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                @if($backup->status === 'completed')
                                                    ...
                                                    <form action="{{ route('backups.restore', $backup) }}" method="POST" class="inline"
                                                        ...
                                                        @csrf
                                                        <button type="submit" class="text-amber-600 hover:text-amber-800 dark:text-amber-400" title="Restore">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-12">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400 mb-4">Create your first backup to protect your data.</p>
                                            <form action="{{ route('backups.create') }}" method="POST" class="inline">
                                                @csrf
            ...
            <div class="mt-6 card">
                <div class="card-header">
                    <h3 class="text-lg font-medium">Automated Backups</h3>
                </div>
                <div class="card-body">
